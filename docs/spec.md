...
## Vision
Build a Docusaurus-powered site for collating crochet recipes written in Markdown/MDX and displaying them in a semi-interactive form. The site should keep the interactive layer lightweight and client-side while remaining flexible for richer components later (diagrams, animations, richer data sources).
